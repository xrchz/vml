...
val mlstring_ty = Type.mk_thy_type {Tyop = "mlstring", Thy = "lib", Args = []}
...
val (strlit_tm,mk_strlit,dest_strlit,is_strlit) = HolKernel.syntax_fns1 "lib" "Strlit"
...
val (mlstring_case_tm,mk_mlstring_case,dest_mlstring_case,is_mlstring_case) = cbinop "lib" "mlstring_CASE"
